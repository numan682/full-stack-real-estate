...
type HomeSectionRenderConfig = CmsSectionConfig & {
...
export function HomePageTemplate() {
  ...
  const navigation = cmsConfig.navigation ?? [];
  const configuredSections = cmsConfig.homeSections ?? ([] as HomeSectionRenderConfig[]);
  ...
  return (
    <TemplatePageShell scripts={homePageScripts}>
      <div className="main-page-wrapper">
        <SitePreloader />
        <SiteHeader content={globalSettings.header} branding={branding} navigation={navigation} />
        {sections
        ...
        <SiteFooter content={globalSettings.footer} branding={branding} navigation={navigation} />
        <LoginModal />
        <ScrollTopButton />
      </div>
    </TemplatePageShell>
