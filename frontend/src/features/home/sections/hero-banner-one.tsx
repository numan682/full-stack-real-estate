...
export function HeroBannerOneSection({ content }: { content?: HeroBannerContent }) {
  const headline = content?.headline ?? "Get the ideal home for your family";
  const subtitle = content?.subtitle ?? "We’ve more than 745,000 apartments, place & plot.";
        			...
        			<div className="container position-relative">
        				<div className="row">
        					<div className="col-xxl-10 col-xl-9 col-lg-10 col-md-10 m-auto">
        						<h1 className="hero-heading text-center wow fadeInUp">{headline}</h1>
        						<p className="fs-24 color-dark text-center pt-35 pb-35 wow fadeInUp" data-wow-delay="0.1s">{subtitle}</p>
        					</div>
        				</div>
        				<div className="row">
