...
import { fetchAdminProperty } from "@/lib/admin/backend-client";
...
export default async function PropertyEditPage({ params, searchParams }: PropertyEditPageProps) {
  ...
  const response = await fetchAdminProperty(propertyId);
    ...
    <section>
      <div className="admin-header">
        <div>
          ...
          <p className="admin-subtitle">Update inventory, pricing, location, and publishing details.</p>
        </div>
          ...
          <div className="admin-row">
            ...
            <div className="admin-field" style={{ gridColumn: "span 12" }}>
              <label htmlFor="is_featured">
                <input id="is_featured" name="is_featured" type="checkbox" defaultChecked={property.is_featured} /> Mark as featured
              </label>
            </div>
          </div>
