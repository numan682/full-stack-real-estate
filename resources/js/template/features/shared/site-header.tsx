...
export function SiteHeader({ content }: { content?: SiteHeaderContent }) {
  ...
  const announcementLink = content?.announcement_link ?? "/listing_01";
  const loginLabel = content?.login_label ?? "Login";
  const addListingLabel = content?.add_listing_label ?? "Add Listing";
        					...
        					<div className="d-flex align-items-center justify-content-between">
        						...
        						<div className="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
        							<ul className="d-flex align-items-center style-none">
        								<li>
        									<a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" className="btn-one"><i className="fa-regular fa-lock"></i> <span>{loginLabel}</span></a>
                                        </li>
        								<li className="d-none d-md-inline-block ms-3">
                                            <a href="/dashboard/add-property" className="btn-two" target="_blank" rel="noopener noreferrer"><span>{addListingLabel}</span> <i className="fa-thin fa-arrow-up-right"></i></a>
                                        </li>
        							</ul>
        						</div>
        							...
        							<div className="collapse navbar-collapse" id="navbarNav">
        								<ul className="navbar-nav align-items-lg-center">
        									...
        									<li className="d-md-none ps-2 pe-2 mt-20">
        										<a href="/dashboard/add-property" className="btn-two w-100" target="_blank" rel="noopener noreferrer"><span>{addListingLabel}</span> <i className="fa-thin fa-arrow-up-right"></i></a>
        									</li>
        								</ul>
        							</div>
        						</nav>
